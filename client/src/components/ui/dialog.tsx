...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-base font-semibold text-[#111111] leading-none tracking-tight", className)}
    {...props}
  />
));
